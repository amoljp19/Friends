...
class Friend {
	int fnum;     // array index number of neighbor vertex
	Friend next;  // pointer to the next neighbor in the list i.e next friend
...
// this class represents vertices of friendship graph
class Person {
	String name;
	boolean student;     //is student or not
	String school;
	Friend first;        // neighbor adjList (i.e pointer pointing to first neighbor)
}
...
public class Graph {
	...
	// all the members in the graph   (array of all vertices index)
	Person[] members;
